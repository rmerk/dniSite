...
To use these stylesheets, rename the files and dnisandbox with the name of your theme.
...
dnisandbox-alpha-default-narrow.css  
...
dnisandbox-alpha-default-normal.css
...
dnisandbox-alpha-default-wide.css
